...
<Library LVVersion="12008004">
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			...
			<Item Name="Enable Output.vi" Type="VI" URL="../Action-Status/Enable Output.vi"/>
		</Item>
		<Item Name="Configure" Type="Folder">
			<Item Name="Low Level" Type="Folder">
				...
				<Item Name="Configure Trigger.vi" Type="VI" URL="../Configure/Low Level/Configure Trigger.vi"/>
			</Item>
			<Item Name="Configure.mnu" Type="Document" URL="/&lt;instrlib&gt;/Agilent 33XXX Series/Public/Configure/Configure.mnu"/>
			<Item Name="Configure Arbitrary Waveform.vi" Type="VI" URL="../../../IPG Pulse Control/Public/Configure/Configure Arbitrary Waveform.vi"/>
			...
			<Item Name="Configure Modulation (Burst).vi" Type="VI" URL="../Configure/Configure Modulation (Burst).vi"/>
			...
			<Item Name="Configure Output Impedance.vi" Type="VI" URL="../../../YAG AOM Pulse Control/Public/Configure/Configure Output Impedance.vi"/>
			...
			<Item Name="Configure Standard Waveform.vi" Type="VI" URL="../Configure/Configure Standard Waveform.vi"/>
			<Item Name="Create Arbitrary Waveform.vi" Type="VI" URL="../../../IPG Pulse Control/Public/Configure/Create Arbitrary Waveform.vi"/>
		</Item>
	...
	<Item Name="Private" Type="Folder">
		...
		<Item Name="Scale Arbitrary Waveform.vi" Type="VI" URL="../../../IPG Pulse Control/Private/Scale Arbitrary Waveform.vi"/>
	</Item>
